using CommerceHub.Cart.Domain.Models;
...
public class CartDomainTests
{
    ...
    {
        var cart = new global::CommerceHub.Cart.Domain.Models.Cart { Id = "cart:user:1" };
    ...
    {
        var cart = new global::CommerceHub.Cart.Domain.Models.Cart { Id = "cart:session:abc" };
