...
using CommerceHub.Inventory.Application;
...
builder.ConfigureServiceDefaults("CommerceHub-Inventory");
...
app.MapGet("/", () => Results.Ok(new { Service = "CommerceHub Inventory Service", Status = "Running" }));
await app.RunAsync();
