...
using CommerceHub.Analytics.Application;
using CommerceHub.Analytics.Application.Consumers;
...
builder.ConfigureServiceDefaults("CommerceHub-Analytics");
builder.ConfigureHangfire("commercehub-analytics");
...
app.MapGet("/", () => Results.Ok(new { Service = "CommerceHub Analytics Service", Status = "Running" }));
await app.RunAsync();
