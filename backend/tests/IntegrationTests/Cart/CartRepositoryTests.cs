...
namespace CommerceHub.Modules.Cart.IntegrationTests;
...
public class CartRepositoryTests : IntegrationTestBase
{
    ...
    {
        var cart = new CommerceHub.Modules.Cart.Domain.Models.Cart
        {
            Id = "cart:user:999",
            UserId = 999,
            Items = new List<CommerceHub.Modules.Cart.Domain.Models.CartItem>
            {
    ...
    {
        var sessionCart = new CommerceHub.Modules.Cart.Domain.Models.Cart
        {
        ...
        var userCart = new CommerceHub.Modules.Cart.Domain.Models.Cart
        {
            Id = "cart:user:888",
            UserId = 888,
            Items = new List<CommerceHub.Modules.Cart.Domain.Models.CartItem>
