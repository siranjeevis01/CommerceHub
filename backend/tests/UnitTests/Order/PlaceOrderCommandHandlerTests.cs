...
namespace CommerceHub.Modules.Order.UnitTests;
...
public class PlaceOrderCommandHandlerTests
{
    ...
    {
        var orders = new List<global::CommerceHub.Modules.Order.Domain.Entities.Order>().AsQueryable();
        ...
        _contextMock.Setup(x => x.Orders.Add(It.IsAny<global::CommerceHub.Modules.Order.Domain.Entities.Order>()))
            .Callback<global::CommerceHub.Modules.Order.Domain.Entities.Order>(o => { o.Id = 1; });
        ...
        _contextMock.Verify(x => x.Orders.Add(It.IsAny<global::CommerceHub.Modules.Order.Domain.Entities.Order>()), Times.Once);
    ...
    public async Task Handle_ShouldCalculateTotalAmount_Correctly()
    {
        ...
        global::CommerceHub.Modules.Order.Domain.Entities.Order? capturedOrder = null;
        _contextMock.Setup(x => x.Orders.Add(It.IsAny<global::CommerceHub.Modules.Order.Domain.Entities.Order>()))
            .Callback<global::CommerceHub.Modules.Order.Domain.Entities.Order>(o => capturedOrder = o);
