...
using CommerceHub.Modules.Order.Application.Queries;
using CommerceHub.Modules.Order.Domain.Entities;
using OrderEntity = CommerceHub.Modules.Order.Domain.Entities.Order;

namespace CommerceHub.Modules.Order.Application.Mappings;
